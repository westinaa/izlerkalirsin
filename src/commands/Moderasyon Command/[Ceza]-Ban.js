...
module.exports = {
  ...
  run: async (client, message, args, embed) => {
    ...
    const westinabuton = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('westina').setLabel("Sunucudan Yasaklandı").setStyle(2).setEmoji(bann).setDisabled(true))
    ...
    `,components:[westinabuton],files:["https://i.makeagif.com/media/5-03-2019/VMiwHX.gif"]}).then((e) => setTimeout(() => { e.delete(); }, 50000));
