...
client.on('interactionCreate', async (interaction) => {
  if (interaction.customId === 'kabul') {
    const modal = new ModalBuilder()
      ...
      const westina = new TextInputBuilder()
          .setCustomId('isim')
          .setLabel('İsim veya Nickname')
          .setStyle(TextInputStyle.Paragraph)
          .setMinLength(2)
          .setMinLength(2)
          .setPlaceholder("İsim ve yaşınızı giriniz. Örn: westina 20")
      
          const AOne = new ActionRowBuilder().addComponents(westina);
    ...
    const modal = new ModalBuilder()
      ...
      const westina = new TextInputBuilder()
          ...
          const AOnee = new ActionRowBuilder().addComponents(westina);
