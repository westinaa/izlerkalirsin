...
if (!args[0]) return message.reply({ content:"Lütfen bir rol etiketle."})
...
message.reply({ embeds: [embed.setColor(`${hexColor}`).setFooter({ text: `${moment(Date.now()).format("LLL")}`}).setDescription(`
- ${role} rol bilgileri;
