...
channel.wsend({ embeds: [new EmbedBuilder().setColor("#ffffff").setAuthor({ name: client.guilds.cache.get(allah.GuildID).name, iconURL: client.guilds.cache.get(allah.GuildID).iconURL({dynamic:true})}).setThumbnail(newState.member.displayAvatarURL({ dynamic: true, size: 2048 })) 
.setDescription(`
...
channel.wsend({ embeds: [new EmbedBuilder().setColor("#ffffff").setAuthor({ name: client.guilds.cache.get(allah.GuildID).name, iconURL: client.guilds.cache.get(allah.GuildID).iconURL({dynamic:true})}).setThumbnail(oldState.member.displayAvatarURL({ dynamic: true, size: 2048 })) 
.setDescription(`
...
const channel2 = client.channels.cache.find(x => x.name == "voice_log");
if (!channel2) return;

if (oldState.channel.id && oldState.selfMute && !newState.selfMute) {
channel2.wsend({ embeds: [new EmbedBuilder().setColor("#ffffff").setAuthor({ name: client.guilds.cache.get(allah.GuildID).name, iconURL: client.guilds.cache.get(allah.GuildID).iconURL({dynamic:true})}).setThumbnail(newState.member.displayAvatarURL({ dynamic: true, size: 2048 })) 
.setDescription(`
